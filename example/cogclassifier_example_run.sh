...
CUSTOM_COUNT_RESULT_FILE01=${CUSTOM_DIR}/classifier_count_add_no_classify.tsv
CUSTOM_COUNT_RESULT_FILE02=${CUSTOM_DIR}/classifier_count_change_color.tsv
mkdir -p $CUSTOM_DIR
...
plot_cog_classifier_barchart -i $CUSTOM_COUNT_RESULT_FILE01 \
                             -o ${OUTDIR}/06_barchart_custom_add_no_classify.html

plot_cog_classifier_barchart -i $CUSTOM_COUNT_RESULT_FILE02 \
...
plot_cog_classifier_piechart -i $CUSTOM_COUNT_RESULT_FILE01 \
